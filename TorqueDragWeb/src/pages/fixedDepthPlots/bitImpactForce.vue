    ...
    methods:{
        ...
        createChart() {
			...
			var bitImpactForce = {
				...
				mode: 'lines',
				type: 'scatter',
				name: 'Bit Impact Force',
				actualName: 'bitImpactForce'
			}
			...
			for(j = 0; j < simulationResultsDTOsCount; j++){
                ...
                bitImpactForce.x.push(rigDTO.pumpFlowRate[j]);
                bitImpactForce.y.push(hydraulicsResults[0].bitImpactForce);
				
				
	
			}

			bitImpactForce.line.color = 'blue'

			data.push(bitImpactForce)
			...
			var tableData = {
				...
				excelFileName: "Bit Impact Force.csv",
				tableTitle: "Bit Impact Force",
				isReversed: true
			}
