            ...
            <div class="col-12">
                 <q-card class="my-card bg-secondary text-white" style="height:70px;">
                    <q-card-section align="right">
                        <div class="row">
                            <div class="col text-center text-subtitle1 q-pb-md">Slide Drilling</div>
...
export default {
    computed:{
        ...
        slideDrillingResults() {
            return this.$store.getters['simulationStore/slideDrillingResults'];
        }
    },
    components:{
		chartToTable
    ...
    data () {
        ...
        excelFileNameLoadData: "Slide Drilling Load Data.csv",
        tableTitleLoadData: "Slide Drilling Load Data",
        excelFileNameStressData: "Slide Drilling Stress Data.csv",
        tableTitleStressData: "Slide Drilling Stress Data"
    }
  },
  methods: {
      toggleTable(){
          var context = this;
          var tableData = {
                data: context.slideDrillingResults,
                columns: [],
				excelFileName: "",
				tableTitle: ""
            }
            ...
            if(context.isLoadData == false){
                ...
                tableData.excelFileName = context.excelFileNameLoadData
                tableData.tableTitle = context.tableTitleLoadData
                context.isLoadData = true;
            }else{
                tableData.columns = context.columnsStressData;
                tableData.excelFileName = context.excelFileNameStressData
                tableData.tableTitle = context.tableTitleStressData
      ...
      onItemClick(selectedItem){
          ...
          this.$store.commit('simulationStore/setSlideDrillingResults', simulationResultsDTO.slideDrillingResults);
           var tableData = {
                data: simulationResultsDTO.slideDrillingResults,
                columns: context.columns,
				excelFileName: context.excelFileNameLoadData,
				tableTitle: context.tableTitleLoadData
			}
