...
export default {
    ...
    data () {
        ...
        excelFileNameLoadData: "Rotating Off Bottom Load Data.csv",
        tableTitleLoadData: "Rotating Off Bottom Load Data",
        excelFileNameStressData: "Rotating Off Bottom Stress Data.csv",
        tableTitleStressData: "Rotating Off Bottom Stress Data"
    }
  },
  methods: {
      toggleTable(){
          var context = this;
          var tableData = {
                data: context.rotatingOffBottomResults,
                columns: [],
				excelFileName: "",
				tableTitle: ""
            }
      ...
      onItemClick(selectedItem){
          ...
          this.$store.commit('simulationStore/setRotatingOffBottomResults', simulationResultsDTO.rotatingOffBottomResults);
           var tableData = {
                data: simulationResultsDTO.rotatingOffBottomResults,
