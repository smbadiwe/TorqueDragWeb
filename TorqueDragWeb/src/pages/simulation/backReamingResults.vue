...
export default {
    ...
    data () {
        ...
        excelFileNameLoadData: "Back Reaming Load Data.csv",
        tableTitleLoadData: "Back Reaming Load Data",
        excelFileNameStressData: "Back Reaming Stress Data.csv",
        tableTitleStressData: "Back Reaming Stress Data"
    }
  },
  methods: {
      toggleTable(){
          var context = this;
          var tableData = {
                data: context.backReamingResults,
                columns: [],
				excelFileName: "",
				tableTitle: ""
            }
      ...
      onItemClick(selectedItem){
          ...
          this.$store.commit('simulationStore/setBackReamingResults', simulationResultsDTO.backReamingResults);
           var tableData = {
                data: simulationResultsDTO.backReamingResults,
