        ...
        createChart() {
			...
			for(j = 0; j < simulationResultsDTOsCount; j++){
                ...
                for(i = 0; i < length; i++){
                    ...
                    hoop.x.push(trippingInResults[i].hoopStressInner/M);
                    hoop.y.push(md);
                    radial.x.push(trippingInResults[i].radialStressInner/M);
                    radial.y.push(md);
                    torsion.x.push(trippingInResults[i].torsionStressInner/M);
                    torsion.y.push(md);
                    shear.x.push(trippingInResults[i].shearStress/M);
                    shear.y.push(md);
                    axial.x.push(trippingInResults[i].axilStressInner/M);
                    axial.y.push(md);
                    buckling.x.push(trippingInResults[i].bucklingStressOuter/M);
                    buckling.y.push(md);
                    bending.x.push(trippingInResults[i].bendingStressInner/M);
                    bending.y.push(md);
                    vonMises.x.push(trippingInResults[i].vonMisesStressInner/M);
                    vonMises.y.push(md);
                }
			...
			var tableData = {
				...
				excelFileName: "TripInStress.csv",
				tableTitle: "Trip In Stress",
				isReversed: true
			}
