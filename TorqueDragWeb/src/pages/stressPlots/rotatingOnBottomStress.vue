    ...
    methods:{
        ...
        createChart() {
			...
			var data  = [];
			 ...
			 for(j = 0; j < simulationResultsDTOsCount; j++){
                ...
                for(i = 0; i < length; i++){
                    ...
                    hoop.x.push(drillingResults[i].hoopStressInner/M);
                    hoop.y.push(md);
                    radial.x.push(drillingResults[i].radialStressInner/M);
                    radial.y.push(md);
                    torsion.x.push(drillingResults[i].torsionStressInner/M);
                    torsion.y.push(md);
                    shear.x.push(drillingResults[i].shearStress/M);
                    shear.y.push(md);
                    axial.x.push(drillingResults[i].axilStressInner/M);
                    axial.y.push(md);
                    buckling.x.push(drillingResults[i].bucklingStressOuter/M);
                    buckling.y.push(md);
                    bending.x.push(drillingResults[i].bendingStressInner/M);
                    bending.y.push(md);
                    vonMises.x.push(drillingResults[i].vonMisesStressInner/M);
                    vonMises.y.push(md);
                }
			...
			var tableData = {
				...
				excelFileName: "RotatingOnBottomStress.csv",
				tableTitle: "Rotating On Bottom Stress",
				isReversed: true
			}
			...
			var layout = { 
				showlegend: true,
				title: 'Rotating On Bottom Stress',
				height: 900,
				xaxis: {
					title: 'Stress (psi)',
					titlefont: {
