        ...
        createChart() {
            ...
            for(j = 0; j < simulationResultsDTOsCount; j++){
                ...
                for(i = 0; i < length; i++){
                    ...
                    hoop.x.push(trippingOutResults[i].hoopStressInner/M);
                    hoop.y.push(md);
                    radial.x.push(trippingOutResults[i].radialStressInner/M);
                    radial.y.push(md);
                    torsion.x.push(trippingOutResults[i].torsionStressInner/M);
                    torsion.y.push(md);
                    shear.x.push(trippingOutResults[i].shearStress/M);
                    shear.y.push(md);
                    axial.x.push(trippingOutResults[i].axilStressInner/M);
                    axial.y.push(md);
                    buckling.x.push(trippingOutResults[i].bucklingStressOuter/M);
                    buckling.y.push(md);
                    bending.x.push(trippingOutResults[i].bendingStressInner/M);
                    bending.y.push(md);
                    vonMises.x.push(trippingOutResults[i].vonMisesStressInner/M);
                    vonMises.y.push(md);
                }
			...
			var tableData = {
				...
				excelFileName: "TripOutStress.csv",
				tableTitle: "Trip Out Stress",
				isReversed: true
			}
