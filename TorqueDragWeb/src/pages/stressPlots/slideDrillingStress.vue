        ...
        createChart() {
			...
			for(j = 0; j < simulationResultsDTOsCount; j++){
                ...
                for(i = 0; i < length; i++){
                    ...
                    hoop.x.push(slideDrillingResults[i].hoopStressInner/M);
                    hoop.y.push(md);
                    radial.x.push(slideDrillingResults[i].radialStressInner/M);
                    radial.y.push(md);
                    torsion.x.push(slideDrillingResults[i].torsionStressInner/M);
                    torsion.y.push(md);
                    shear.x.push(slideDrillingResults[i].shearStress/M);
                    shear.y.push(md);
                    axial.x.push(slideDrillingResults[i].axilStressInner/M);
                    axial.y.push(md);
                    buckling.x.push(slideDrillingResults[i].bucklingStressOuter/M);
                    buckling.y.push(md);
                    bending.x.push(slideDrillingResults[i].bendingStressInner/M);
                    bending.y.push(md);
                    vonMises.x.push(slideDrillingResults[i].vonMisesStressInner/M);
                    vonMises.y.push(md);
                }
			...
			var tableData = {
				...
				excelFileName: "SlideDrillingStress.csv",
				tableTitle: "Slide Drilling Stress",
				isReversed: true
			}
