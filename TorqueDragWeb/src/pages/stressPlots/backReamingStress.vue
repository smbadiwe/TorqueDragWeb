        ...
        createChart() {
            ...
            for(j = 0; j < simulationResultsDTOsCount; j++){
                ...
                for(i = 0; i < length; i++){
                    ...
                    hoop.x.push(backReamingResults[i].hoopStressInner/M);
                    hoop.y.push(md);
                    radial.x.push(backReamingResults[i].radialStressInner/M);
                    radial.y.push(md);
                    torsion.x.push(backReamingResults[i].torsionStressInner/M);
                    torsion.y.push(md);
                    shear.x.push(backReamingResults[i].shearStress/M);
                    shear.y.push(md);
                    axial.x.push(backReamingResults[i].axilStressInner/M);
                    axial.y.push(md);
                    buckling.x.push(backReamingResults[i].bucklingStressOuter/M);
                    buckling.y.push(md);
                    bending.x.push(backReamingResults[i].bendingStressInner/M);
                    bending.y.push(md);
                    vonMises.x.push(backReamingResults[i].vonMisesStressInner/M);
                    vonMises.y.push(md);
                }
			...
			var tableData = {
				...
				excelFileName: "BackReamingStress.csv",
				tableTitle: "Back Reaming Stress",
				isReversed: true
			}
