                    ...
                    <div class="col-12 q-pa-sm">
                        ...
                        >
                            ...
                            <q-card-section>
                                ...
                                <div class="col-6 q-pa-sm">Length (ft)</div>
                                <div class="col-6 q-pa-sm"><input class="text-center bg-positive text-accent" v-model="length"></div>
                                <!-- <div class="col-3 q-pa-sm">ft</div> -->

                                <div class="col-6 q-pa-sm">Measured Depth (ft)</div>
                                <div class="col-6 q-pa-sm"><input class="text-center bg-positive text-accent" v-model="measuredDepth"></div>
                                <!-- <div class="col-3 q-pa-sm">ft</div> -->

                                <div class="col-6 q-pa-sm">Size (in)</div>
                                <div class="col-6 q-pa-sm"><input class="text-center bg-positive text-accent" v-model="size"></div>
                                <!-- <div class="col-3 q-pa-sm">in</div> -->

                                <div class="col-6 q-pa-sm">Weight (Ibf)</div>
                                ...
                                <div class="col-6 q-pa-sm">Grade</div>
                                <div class="col-6 q-pa-sm"><input class="text-center bg-positive text-accent" v-model="grade"></div>
                                <!-- <div class="col-3 q-pa-sm"></div> -->

                                <div class="col-6 q-pa-sm">Outer Diameter (in)</div>
                                <div class="col-6 q-pa-sm"><input class="text-center bg-positive text-accent" v-model="outerDiameter"></div>
                                <!-- <div class="col-3 q-pa-sm">in</div> -->

                                <div class="col-6 q-pa-sm">Inner Diameter (in)</div>
                                <div class="col-6 q-pa-sm"><input class="text-center bg-positive text-accent" v-model="innerDiameter"></div>
                                <!-- <div class="col-3 q-pa-sm">in</div> -->

                                <div class="col-6 q-pa-sm">Minimum Yield Strength</div>
                                <div class="col-6 q-pa-sm"><input class="text-center bg-positive text-accent" v-model="minimumYieldStrength"></div>
                                <!-- <div class="col-3 q-pa-sm">in</div> -->

                                <div class="col-6 q-pa-sm">Make-Up Torque</div>
                                <div class="col-6 q-pa-sm"><input class="text-center bg-positive text-accent" v-model="makeUpTorque"></div>
                                <!-- <div class="col-3 q-pa-sm">in</div> -->

                                <div class="col-6 q-pa-sm">Over-Pull Margin</div>
                                <div class="col-6 q-pa-sm"><input class="text-center bg-positive text-accent" v-model="overPullMargin"></div>
                                <!-- <div class="col-3 q-pa-sm">in</div> -->

                                <div class="col-6 q-pa-sm">Item Description</div>
                                <div class="col-6 q-pa-sm"><input class="text-center bg-positive text-accent" type="textarea" v-model="itemDescription"></div>
                                <!-- <div class="col-3 q-pa-sm"></div> -->
