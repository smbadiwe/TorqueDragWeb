<template>
    <div>
        <svg class="Rectangle_79_du_rigview">
            <linearGradient id="rect_rigview" spreadMethod="pad" x1="0.488" x2="0.488" y1="0.5" y2="-0.441">
